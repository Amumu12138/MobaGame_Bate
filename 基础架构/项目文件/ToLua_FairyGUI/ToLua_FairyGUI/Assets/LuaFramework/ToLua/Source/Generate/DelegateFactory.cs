...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<GameFramework.SessionData>), factory.System_Action_GameFramework_SessionData);
		...
		dict.Add(typeof(LoadCompleteCallback), factory.LoadCompleteCallback);
		dict.Add(typeof(LoadErrorCallback), factory.LoadErrorCallback);
		...
		DelegateTraits<System.Action<GameFramework.SessionData>>.Init(factory.System_Action_GameFramework_SessionData);
		...
		DelegateTraits<LoadCompleteCallback>.Init(factory.LoadCompleteCallback);
		DelegateTraits<LoadErrorCallback>.Init(factory.LoadErrorCallback);
		...
		TypeTraits<System.Action<GameFramework.SessionData>>.Init(factory.Check_System_Action_GameFramework_SessionData);
		...
		TypeTraits<LoadCompleteCallback>.Init(factory.Check_LoadCompleteCallback);
		TypeTraits<LoadErrorCallback>.Init(factory.Check_LoadErrorCallback);
		...
		StackTraits<System.Action<GameFramework.SessionData>>.Push = factory.Push_System_Action_GameFramework_SessionData;
		...
		StackTraits<LoadCompleteCallback>.Push = factory.Push_LoadCompleteCallback;
		StackTraits<LoadErrorCallback>.Push = factory.Push_LoadErrorCallback;
	}
	...
	class System_Action_GameFramework_SessionData_Event : LuaDelegate
	{
		public System_Action_GameFramework_SessionData_Event(LuaFunction func) : base(func) { }
		public System_Action_GameFramework_SessionData_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(GameFramework.SessionData param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(GameFramework.SessionData param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<GameFramework.SessionData> System_Action_GameFramework_SessionData(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<GameFramework.SessionData> fn = delegate(GameFramework.SessionData param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_GameFramework_SessionData_Event target = new System_Action_GameFramework_SessionData_Event(func);
			System.Action<GameFramework.SessionData> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_GameFramework_SessionData_Event target = new System_Action_GameFramework_SessionData_Event(func, self);
			System.Action<GameFramework.SessionData> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_GameFramework_SessionData(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<GameFramework.SessionData>), L, pos);
	}

	void Push_System_Action_GameFramework_SessionData(IntPtr L, System.Action<GameFramework.SessionData> o)
	{
		ToLua.Push(L, o);
	}
	...
	class LoadCompleteCallback_Event : LuaDelegate
	{
		public LoadCompleteCallback_Event(LuaFunction func) : base(func) { }
		public LoadCompleteCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	bool Check_LoadCompleteCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LoadCompleteCallback), L, pos);
	}
	...
	class LoadErrorCallback_Event : LuaDelegate
	{
		public LoadErrorCallback_Event(LuaFunction func) : base(func) { }
		public LoadErrorCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	bool Check_LoadErrorCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LoadErrorCallback), L, pos);
	}
